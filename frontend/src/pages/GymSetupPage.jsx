...
export const GymSetupPage = () => {
  ...
  if (existingGym) {
    return (
      <div className='max-w-4xl mx-auto p-6'>
        <h1 className='text-4xl font-bold text-gray-800 mb-8'>Your Gym</h1>

        <div className='bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-lg shadow-xl p-8 mb-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
            <div className='bg-blue-500 bg-opacity-50 rounded p-4'>
              <p className='text-blue-100 text-sm font-semibold mb-1'>Gym Code</p>
              <p className='text-4xl font-bold'>{existingGym.gymCode}</p>
              <p className='text-blue-100 text-sm mt-2'>Share this code with members</p>
            </div>

            <div className='bg-blue-500 bg-opacity-50 rounded p-4'>
              <p className='text-blue-100 text-sm font-semibold mb-1'>Total Members</p>
              <p className='text-4xl font-bold'>{existingGym.totalMembers || 0}</p>
            </div>

            <div className='bg-blue-500 bg-opacity-50 rounded p-4'>
              <p className='text-blue-100 text-sm font-semibold mb-1'>Monthly Fee</p>
              <p className='text-4xl font-bold'>${existingGym.monthlyFee}</p>
            </div>

            <div className='bg-blue-500 bg-opacity-50 rounded p-4'>
              <p className='text-blue-100 text-sm font-semibold mb-1'>Facilities</p>
              <p className='text-2xl font-bold'>{existingGym.facilities?.length || 0}</p>
            </div>
          </div>

          <div className='bg-blue-500 bg-opacity-30 rounded p-4'>
            <p className='text-blue-100 text-sm font-semibold mb-2'>Location</p>
          ...
          <button
            ...
            className='mt-8 w-full bg-white text-blue-600 font-bold py-3 rounded-lg hover:bg-blue-50'
          >
            Manage Members
          </button>
        </div>
  ...
  return (
    <div className='max-w-2xl mx-auto p-6'>
      <h1 className='text-4xl font-bold text-gray-800 mb-2'>Create Your Gym</h1>
      <p className='text-gray-600 mb-8'>Set up your gym profile and get a unique code for members</p>
      ...
      <form onSubmit={handleSubmit} className='bg-white rounded-lg shadow-lg p-8 space-y-6'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div>
            <label className='block text-gray-700 font-semibold mb-2'>Monthly Fee</label>
            <input
              type='number'
          ...
          <div>
            <label className='block text-gray-700 font-semibold mb-2'>Annual Fee</label>
            <input
              type='number'
